...
- [Keel design](../specs/2026-06-17-keel-design.md) — the design spec for keel that this plan implements
- [Execution mode routing](../design-notes/execution-mode-routing.md) — the execution mode selection logic that inline-vs-dispatch depends on
